...
{
    public partial class Addtocatmaybelline : System.Web.UI.Page
    {
            ...
            if(!IsPostBack)
            {
                ...
                if(Request.QueryString["id"]!=null)
                {
                   if(Session["Buyitems"]==null)
                   {
                       ...
                       String myquery ="select * from Maybelline where Product_id="+Request.QueryString["id"];
                       ...
                       Response.Redirect("Addtocartmaybelline.aspx");
                   }
                   else
                   {
