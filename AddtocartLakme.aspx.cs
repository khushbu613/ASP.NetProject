...
{
    public partial class AddtocartLakme : System.Web.UI.Page
    {
             ...
             if(!IsPostBack)
            {
                ...
                if(Request.QueryString["id"]!=null)
                {
                   if(Session["Buyitems"]==null)
                   {
                       ...
                       String myquery ="select * from Lakme1 where Product_id="+Request.QueryString["id"];
                       ...
                       Response.Redirect("AddtocartLakme.aspx");
                   }
                   else
                   {
